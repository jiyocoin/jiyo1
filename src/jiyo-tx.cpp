...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Jiyo Core jiyo-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  jiyo-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jiyo transaction") + "\n" +
                               "  jiyo-tx [options] -create [commands]   " + _("Create hex-encoded jiyo transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded jiyo transaction
