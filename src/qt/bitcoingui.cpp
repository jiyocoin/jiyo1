                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Jiyo Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Jiyo address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and jiyo: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zJIYO"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Jiyo Core"), this);
    aboutAction->setStatusTip(tr("Show information about Jiyo Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Jiyo"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Jiyo addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Jiyo addresses"));
    ...
    openAction->setStatusTip(tr("Open a Jiyo: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Jiyo Core help message to get a list with possible Jiyo command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Jiyo Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Jiyo network", "", count));
}
...
{
    QString strTitle = tr("Jiyo Core"); // default title
