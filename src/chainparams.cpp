...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x0000066e30a469e6a4a3fc73ffa500ba19d852e57e36e70dbb03d47fb865538d"))
    (36884, uint256("7bb3cae975d7272d4ee732e4e695d63b74456f5d99a3463bd518f4ee7218b306")); 
...
public:
    CMainParams()
    {
        ...
        nZerocoinStartTime = 1520100931; // 3-3-2018 18:15pm - GMT
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1520014937;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 615683;
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet jiyo script addresses start with '8' or '9'
