...
This mechanism has been integrated into Bitcore-Node-Jiyo which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: 
* API:  
...
This value can be overridden by passing the following argument to the Jiyo Core daemon:
