...
If you want to build Jiyo-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a jiyo-qt executable will be
built by default.
...
Security
--------
To help make your Jiyo installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, jiyo should be built with a non-executable stack
