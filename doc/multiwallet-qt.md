...
In order to support loading of multiple wallets in jiyo-qt, a few changes in the UI architecture will be needed.
...
Changes to jiyo.cpp
----------------------
jiyo.cpp is the entry point into jiyo-qt, and as such, will require some minor modifications to provide hooks for
