...
VERSION=
commit=false
url=https://github.com/jiyoproject/jiyo
proc=2
mem=2000
lxc=true
...
then
    ...
    git clone https://github.com/jiyoproject/gitian.sigs.git
    git clone https://github.com/jiyoproject/jiyo-detached-sigs.git
